...
"""
the Debug charactors are used to mark modification for HighDim Koopman after NNDMDc training
"""
...
class CustomObservables(BaseObservables):
    ...
    def __init__(self, observables, observable_names=None, interaction_only=True):
        ...
        # self.observables = [identity, *observables] # Debug
    ...
    def fit(self, x, y=None):
        ...
        # self.n_output_features_ = n_output_features # Debug
        self.n_output_features_ = 128
    ...
    def transform(self, x):
        ...
        # print("#################### INTO transform #######################")    # Debug

        check_is_fitted(self, "n_input_features_")
        check_is_fitted(self, "n_output_features_")
        x = validate_input(x)

        # print(f"### after validation: {x.shape}")    # Debug
        ...
        # print(f"### after empty: {x_transformed.shape}")    # Debug

        observables_idx = 0
        # print(f"### observables = {self.observables}")  # Debug

        for f in self.observables:

            # print(f"### n_input_features = {self.n_input_features_}")   # Debug
            # print(f"### f,coargcout = {f.__code__.co_argcount}")   # Debug
            # print(f"### self.interaction_only = {self.interaction_only}")   # Debug
            ...
            for k in range(n_samples):      # Debug
                x_transformed[k, :] = f(x[k, :])

        # print(f"### before transformed: {x.shape}")    # Debug
        # print(f"### after transformed: {x_transformed.shape}")    # Debug
